							...
							<a href="/profile/munsu-bae/settings">
								<div class="user-avatar">
									<div aria-label="Munsu-Bae" class="pic" role="img"
										style="background-image: url(${pageContext.request.contextPath}/assets/images/placeholders/placeholder_2.png)"></div>
			...
			<div class="email-signup">
				<form data_behavior="email-signup" action="/email_signups"
					...
					<input name="utf8" type="hidden" value="✓"><input
						...
						value="ONBE5WHhJhhl19BeY8yZ2BoYs48jrBmi89rDcaLAl/FZquqhrIgg4IpennJ0imdFHxTiBAI4xE0WRmQg9y384g==">
						...
						<div style="width: 304px; height: 78px;">
							<div>
								<iframe title="reCAPTCHA" width="304" height="78"
									role="presentation" name="a-7dglv9mzq4cm" frameborder="0"
									scrolling="no"
									sandbox="allow-forms allow-popups allow-same-origin allow-scripts allow-top-navigation allow-modals allow-popups-to-escape-sandbox allow-storage-access-by-user-activation"
									src="https://www.recaptcha.net/recaptcha/api2/anchor?ar=1&amp;k=6Ld1tO4oAAAAAI0-G63XMzqxtSbnFBpwOfIwxztQ&amp;co=aHR0cHM6Ly9kaXN0aWxsZXIuY29tOjQ0Mw..&amp;hl=ko&amp;v=rKbTvxTxwcw5VqzrtN-ICwWt&amp;size=normal&amp;cb=abg7i9c3edif"></iframe>
							</div>
